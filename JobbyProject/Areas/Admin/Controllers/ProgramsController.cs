...
namespace JobbyProject.Areas.Admin.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,IconImg,Description")] Program program)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,IconImg,Description")] Program program)
        {
            if (ModelState.IsValid)
            {
